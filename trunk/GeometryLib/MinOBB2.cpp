...
Geom::MinOBB2::MinOBB2 (QVector<Vector2> &points)
{
    // Get the convex hull of the points.
    QVector<Vector2> hullPoints;

	ConvexHull2 hull(points);
	int hullNumSimplices = hull.getNumSimplices();
	QVector<int> hullIndices = hull.getIndices();
    ...
    QVector<Vector2> edges(numPoints, Vector2());
    QVector<bool> visited(numPoints, false);
    int i;
...
void Geom::MinOBB2::UpdateBox (const Vector2& LPoint,
