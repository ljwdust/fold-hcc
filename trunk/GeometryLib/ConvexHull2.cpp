...
Geom::ConvexHull2::ConvexHull2(QVector<Vector2> &pnts)
	:mVertices(pnts)
{
...
bool Geom::ConvexHull2::getExtremes( QVector<int> &mExtreme )
{
	...
	QVector<Vector2> mDirection(2, Vector2());
...
bool Geom::ConvexHull2::Update (Edge*& hull, int i)
{
...
Geom::ConvexHull2::Edge::Edge (int v0, int v1)
    :Sign(0),  Time(-1)
{
    V[0] = v0;
    V[1] = v1;
...
int Geom::ConvexHull2::Edge::GetSign( int i, QVector<Vector2> &pnts )
{
...
void Geom::ConvexHull2::Edge::Insert (Edge* adj0, Edge* adj1)
{
    adj0->E[1] = this;
    adj1->E[0] = this;
    E[0] = adj0;
...
void Geom::ConvexHull2::Edge::DeleteSelf ()
{
    if (E[0])
    {
        E[0]->E[1] = 0;
...
void Geom::ConvexHull2::Edge::DeleteAll ()
{
    Edge* adj = E[1];
    while (adj && adj != this)
    {
...
//----------------------------------------------------------------------------
void Geom::ConvexHull2::Edge::GetIndices( int& numIndices, QVector<int> &indices )
{
