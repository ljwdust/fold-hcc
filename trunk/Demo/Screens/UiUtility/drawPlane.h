...
Surface_mesh planeX(Vec3d center = Vec3d(0,0,0), double len = 1.0)
{
	Surface_mesh m;
...
Surface_mesh planeY(Vec3d center = Vec3d(0,0,0), double len = 1.0)
{
	Surface_mesh m;
...
Surface_mesh planeZ(Vec3d center = Vec3d(0,0,0), double len = 1.0)
{
	Surface_mesh m;
...
#include "Triangle.h"
Vec3d rayMeshIntersect(Vec3d origin, Vec3d direction, Surface_mesh & mesh)
{
...
void findPlane(GLfloat plane[4], Vec3d &v0, Vec3d &v1, Vec3d &v2)
{
