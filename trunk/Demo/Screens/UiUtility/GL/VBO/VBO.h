...
typedef SurfaceMesh::Point PointType;
typedef SurfaceMesh::Vec3d NormalType;
typedef SurfaceMesh::Vec3d ColorType;
...
public:
	...
	VBO( uint vert_count, const PointType * v, const NormalType * n, const ColorType * c, QVector<uint> &faces );
