...
public:
	...
	static void DrawArrowDirected(Vec3d& pos, Vec3d& normal, float height = 1.0, bool isForward = true, bool isFilledBase = true, float width = 1.0);
	static void DrawArrowDoubleDirected(Vec3d& pos, Vec3d& normal, float height = 1.0, bool isForward = true, bool isFilledBase = true);
